...
export const CoreContextProvider = props => {
        ...
        const login = (email, password, url) => {
            ...
            setShowLoader(true);
            axios.post(apiUrl + '/signin', { Username: email, Password: password }).then((response) => {
        ...
        const fetchPatientListfromApi = async(usertype, userId, AllActive) => {
            ...
            await axios.post(apiUrl + '/DynamoDbAPIs/getitem', data, {
                headers: {
                    Accept: "application/json, text/plain, */*",
                    // "Content-Type": "application/json",
                    Authorization: "Bearer " + token
        ...
        const renderLoader = () => {
            if (showLoader) return ( < span > < img src = { loader }
                alt = "" / > < /span>);
            ...
            const verifyProviderVerificationCode = (code, userName, careTeamType, url = '') => {
                ...
                axios.post(apiUrl + '/confirmsignup', data, {
                    headers: {
                        Accept: "application/json, text/plain, */*",
                        // "Content-Type": "application/json",
                        Authorization: "Bearer " + token
