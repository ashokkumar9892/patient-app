...
const tt=[...coreContext.providerData,...coreContext.ccData,...coreContext.coachData]
    ...
    const handleUpdate=()=>{
        coreContext.fetchTimeLog("PATIENT_" + patientId);setPristine();setPerformedBy("");setTaskType("");setDate("");sett1("");setShowModal(false);coreContext.fetchTimeLog("PATIENT_" + patientId);coreContext.fetchTimeLog("PATIENT_" + patientId);coreContext.fetchTimeLog("PATIENT_" + patientId);settimevalue("");
    }
    const columns = [
        { field: 
          'taskType', 
